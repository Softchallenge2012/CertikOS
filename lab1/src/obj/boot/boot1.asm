...
00000000 <.debug_info>:
  ...
  50:	61                   	popa   
  51:	62 31                	bound  %esi,(%ecx)
  53:	2f                   	das    
  54:	73 68                	jae    be <PROT_MODE_DSEG+0xae>
  56:	61                   	popa   
  57:	72 65                	jb     be <PROT_MODE_DSEG+0xae>
  59:	64 2f                	fs das 
  ...
  75:	00 00                	add    %al,(%eax)
  77:	04 01                	add    $0x1,%al
  79:	75 00                	jne    7b <PROT_MODE_DSEG+0x6b>
  7b:	00 00                	add    %al,(%eax)
  7d:	0c 4d                	or     $0x4d,%al
  7f:	00 00                	add    %al,(%eax)
  81:	00 f8                	add    %bh,%al
  ...
  89:	00 9d 02 00 00 91    	add    %bl,-0x6efffffe(%ebp)
  8f:	00 00                	add    %al,(%eax)
  91:	00 02                	add    %al,(%edx)
  93:	01 06                	add    %eax,(%esi)
  95:	2e 01 00             	add    %eax,%cs:(%eax)
  98:	00 03                	add    %al,(%ebx)
  9a:	63 00                	arpl   %ax,(%eax)
  9c:	00 00                	add    %al,(%eax)
  9e:	02 0d 37 00 00 00    	add    0x37,%cl
  a4:	02 01                	add    (%ecx),%al
  ...
  dc:	00 02                	add    %al,(%edx)
  de:	08 05 d9 00 00 00    	or     %al,0xd9
  e4:	02 08                	add    (%eax),%cl
  e6:	07                   	pop    %es
  e7:	44                   	inc    %esp
 ...
 162:	00 0d e7 00 00 00    	add    %cl,0xe7
 ...
 1ca:	0d 42 00 00 00       	or     $0x42,%eax
 ...
 3e1:	0d f3 00 00 00       	or     $0xf3,%eax
 ...
 532:	00 0d 3d 00 00 00    	add    %cl,0x3d
 ...
 567:	00 0d 37 00 00 00    	add    %cl,0x37
 ...
 593:	0d 2b 00 00 00       	or     $0x2b,%eax
 ...
 625:	02 91 08 10 30 00    	add    0x301008(%ecx),%dl
 ...
 697:	70 00                	jo     699 <PROT_MODE_DSEG+0x689>
 699:	00 00                	add    %al,(%eax)
 69b:	02 2d 03 57 06 00    	add    0x65703,%ch
 ...
 717:	75 00                	jne    719 <PROT_MODE_DSEG+0x709>
 719:	00 00                	add    %al,(%eax)
 71b:	0c 69                	or     $0x69,%al
 ...
 738:	63 00                	arpl   %ax,(%eax)
 73a:	00 00                	add    %al,(%eax)
 73c:	02 0d 37 00 00 00    	add    0x37,%cl
 ...
 77c:	08 05 d9 00 00 00    	or     %al,0xd9
 ...
 d9a:	3d 00 00 00 3d       	cmp    $0x3d000000,%eax
 d9f:	00 00                	add    %al,(%eax)
 da1:	00 02                	add    %al,(%edx)
 da3:	50                   	push   %eax
 da4:	1b e7                	sbb    %edi,%esp
 da6:	00 00                	add    %al,(%eax)
 da8:	00 e7                	add    %ah,%bh
 daa:	00 00                	add    %al,(%eax)
 dac:	00 02                	add    %al,(%edx)
 dae:	78 1b                	js     dcb <PROT_MODE_DSEG+0xdbb>
 db0:	37                   	aaa    
 ...
 e27:	61                   	popa   
 e28:	62 31                	bound  %esi,(%ecx)
 e2a:	2f                   	das    
 e2b:	73 68                	jae    e95 <PROT_MODE_DSEG+0xe85>
 e2d:	61                   	popa   
 e2e:	72 65                	jb     e95 <PROT_MODE_DSEG+0xe85>
 e30:	64 2f                	fs das 
...
00000000 <.debug_str>:
  ...
  32:	72 69                	jb     9d <PROT_MODE_DSEG+0x8d>
  ...
  44:	61                   	popa   
  45:	64 73 65             	fs jae ad <PROT_MODE_DSEG+0x9d>
  48:	63 74 6f 72          	arpl   %si,0x72(%edi,%ebp,2)
  4c:	00 62 6f             	add    %ah,0x6f(%edx)
  4f:	6f                   	outsl  %ds:(%esi),(%dx)
  50:	74 2f                	je     81 <PROT_MODE_DSEG+0x71>
  52:	62 6f 6f             	bound  %ebp,0x6f(%edi)
  55:	74 31                	je     88 <PROT_MODE_DSEG+0x78>
  57:	2f                   	das    
  58:	62 6f 6f             	bound  %ebp,0x6f(%edi)
  5b:	74 31                	je     8e <PROT_MODE_DSEG+0x7e>
  5d:	6c                   	insb   (%dx),%es:(%edi)
  5e:	69 62 2e 63 00 75 69 	imul   $0x69750063,0x2e(%edx),%esp
  65:	6e                   	outsb  %ds:(%esi),(%dx)
  66:	74 38                	je     a0 <PROT_MODE_DSEG+0x90>
  68:	5f                   	pop    %edi
  69:	74 00                	je     6b <PROT_MODE_DSEG+0x5b>
  6b:	6f                   	outsl  %ds:(%esi),(%dx)
  6c:	75 74                	jne    e2 <PROT_MODE_DSEG+0xd2>
  6e:	62 00                	bound  %eax,(%eax)
  70:	69 6e 73 6c 00 47 4e 	imul   $0x4e47006c,0x73(%esi),%ebp
  77:	55                   	push   %ebp
  78:	20 43 31             	and    %al,0x31(%ebx)
  7b:	31 20                	xor    %esp,(%eax)
  7d:	36 2e 33 2e          	ss xor %cs:(%esi),%ebp
  81:	30 20                	xor    %ah,(%eax)
  83:	32 30                	xor    (%eax),%dh
  85:	31 37                	xor    %esi,(%edi)
  87:	30 34 30             	xor    %dh,(%eax,%esi,1)
  8a:	36 20 2d 6d 33 32 20 	and    %ch,%ss:0x2032336d
  91:	2d 6d 74 75 6e       	sub    $0x6e75746d,%eax
  96:	65 3d 67 65 6e 65    	gs cmp $0x656e6567,%eax
  9c:	72 69                	jb     107 <PROT_MODE_DSEG+0xf7>
  9e:	63 20                	arpl   %sp,(%eax)
  a0:	2d 6d 61 72 63       	sub    $0x6372616d,%eax
  a5:	68 3d 69 36 38       	push   $0x3836693d
  aa:	36 20 2d 67 20 2d 4f 	and    %ch,%ss:0x4f2d2067
  b1:	73 20                	jae    d3 <PROT_MODE_DSEG+0xc3>
  b3:	2d 4f 73 20 2d       	sub    $0x2d20734f,%eax
  b8:	66 6e                	data16 outsb %ds:(%esi),(%dx)
  ba:	6f                   	outsl  %ds:(%esi),(%dx)
  bb:	2d 62 75 69 6c       	sub    $0x6c697562,%eax
  c0:	74 69                	je     12b <PROT_MODE_DSEG+0x11b>
  c2:	6e                   	outsb  %ds:(%esi),(%dx)
  c3:	20 2d 66 6e 6f 2d    	and    %ch,0x2d6f6e66
  c9:	73 74                	jae    13f <PROT_MODE_DSEG+0x12f>
  cb:	61                   	popa   
  cc:	63 6b 2d             	arpl   %bp,0x2d(%ebx)
  cf:	70 72                	jo     143 <PROT_MODE_DSEG+0x133>
  d1:	6f                   	outsl  %ds:(%esi),(%dx)
  d2:	74 65                	je     139 <PROT_MODE_DSEG+0x129>
  d4:	63 74 6f 72          	arpl   %si,0x72(%edi,%ebp,2)
  d8:	00 6c 6f 6e          	add    %ch,0x6e(%edi,%ebp,2)
  dc:	67 20 6c 6f          	and    %ch,0x6f(%si)
  e0:	6e                   	outsb  %ds:(%esi),(%dx)
  e1:	67 20 69 6e          	and    %ch,0x6e(%bx,%di)
  e5:	74 00                	je     e7 <PROT_MODE_DSEG+0xd7>
  e7:	72 65                	jb     14e <PROT_MODE_DSEG+0x13e>
  e9:	61                   	popa   
  ea:	64 73 65             	fs jae 152 <PROT_MODE_DSEG+0x142>
  ed:	63 74 69 6f          	arpl   %si,0x6f(%ecx,%ebp,2)
  f1:	6e                   	outsb  %ds:(%esi),(%dx)
  f2:	00 69 74             	add    %ch,0x74(%ecx)
  f5:	6f                   	outsl  %ds:(%esi),(%dx)
  f6:	61                   	popa   
  f7:	00 2f                	add    %ch,(%edi)
  f9:	68 6f 6d 65 2f       	push   $0x2f656d6f
  fe:	73 74                	jae    174 <PROT_MODE_DSEG+0x164>
 100:	75 64                	jne    166 <PROT_MODE_DSEG+0x156>
 102:	65 6e                	outsb  %gs:(%esi),(%dx)
 104:	74 2f                	je     135 <PROT_MODE_DSEG+0x125>
 106:	6f                   	outsl  %ds:(%esi),(%dx)
 107:	73 2d                	jae    136 <PROT_MODE_DSEG+0x126>
 109:	63 6c 61 73          	arpl   %bp,0x73(%ecx,%eiz,2)
 10d:	73 2d                	jae    13c <PROT_MODE_DSEG+0x12c>
 10f:	70 72                	jo     183 <PROT_MODE_DSEG+0x173>
 111:	6f                   	outsl  %ds:(%esi),(%dx)
 112:	6a 65                	push   $0x65
 114:	63 74 2e 72          	arpl   %si,0x72(%esi,%ebp,1)
 118:	65 70 6f             	gs jo  18a <PROT_MODE_DSEG+0x17a>
 11b:	2f                   	das    
 11c:	6c                   	insb   (%dx),%es:(%edi)
 11d:	61                   	popa   
 11e:	62 31                	bound  %esi,(%ecx)
 120:	2f                   	das    
 121:	73 68                	jae    18b <PROT_MODE_DSEG+0x17b>
 123:	61                   	popa   
 124:	72 65                	jb     18b <PROT_MODE_DSEG+0x17b>
 126:	64 2f                	fs das 
 128:	73 72                	jae    19c <PROT_MODE_DSEG+0x18c>
 12a:	63 00                	arpl   %ax,(%eax)
 12c:	75 6e                	jne    19c <PROT_MODE_DSEG+0x18c>
