...
40000030:	8d 83 e4 de ff ff    	lea    -0x211c(%ebx),%eax
...
40000069:	8d 83 f0 de ff ff    	lea    -0x2110(%ebx),%eax
...
400000a2:	8d 83 fc de ff ff    	lea    -0x2104(%ebx),%eax
...
4000027b:	e8 f0 09 00 00       	call   40000c70 <__udivdi3>
...
400002ba:	e8 e1 0a 00 00       	call   40000da0 <__umoddi3>
400002bf:	83 c4 08             	add    $0x8,%esp
400002c2:	57                   	push   %edi
400002c3:	0f be 84 05 08 df ff 	movsbl -0x20f8(%ebp,%eax,1),%eax
400002ca:	ff 
...
400003e4:	03 8c 81 20 df ff ff 	add    -0x20e0(%ecx,%eax,4),%ecx
...
400004fb:	8d 80 19 df ff ff    	lea    -0x20e7(%eax),%eax
...
40000bf1:	8d 83 78 e0 ff ff    	lea    -0x1f88(%ebx),%eax
...
40000bfd:	83 c4 0c             	add    $0xc,%esp
40000c00:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000c06:	68 00 00 00 e0       	push   $0xe0000000
40000c0b:	8d 83 88 e0 ff ff    	lea    -0x1f78(%ebx),%eax
40000c11:	50                   	push   %eax
40000c12:	e8 db f5 ff ff       	call   400001f2 <printf>
    printf("ping: writing the value %d to the address %x\n", val, addr);
40000c17:	83 c4 0c             	add    $0xc,%esp
40000c1a:	68 00 00 00 e0       	push   $0xe0000000
40000c1f:	6a 64                	push   $0x64
40000c21:	8d 83 ac e0 ff ff    	lea    -0x1f54(%ebx),%eax
40000c27:	50                   	push   %eax
40000c28:	e8 c5 f5 ff ff       	call   400001f2 <printf>
    *addr = val;
40000c2d:	c7 05 00 00 00 e0 64 	movl   $0x64,0xe0000000
40000c34:	00 00 00 
    yield();
40000c37:	e8 bc fb ff ff       	call   400007f8 <yield>
    printf("ping: the new value at address %x: %d\n", addr, *addr);
40000c3c:	83 c4 0c             	add    $0xc,%esp
40000c3f:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000c45:	68 00 00 00 e0       	push   $0xe0000000
40000c4a:	8d 83 dc e0 ff ff    	lea    -0x1f24(%ebx),%eax
40000c50:	50                   	push   %eax
40000c51:	e8 9c f5 ff ff       	call   400001f2 <printf>
40000c56:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000c59:	b8 00 00 00 00       	mov    $0x0,%eax
40000c5e:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000c61:	59                   	pop    %ecx
40000c62:	5b                   	pop    %ebx
40000c63:	5d                   	pop    %ebp
40000c64:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c67:	c3                   	ret    
40000c68:	66 90                	xchg   %ax,%ax
40000c6a:	66 90                	xchg   %ax,%ax
40000c6c:	66 90                	xchg   %ax,%ax
40000c6e:	66 90                	xchg   %ax,%ax
...
40000c74:	83 ec 1c             	sub    $0x1c,%esp
40000c77:	8b 74 24 3c          	mov    0x3c(%esp),%esi
40000c7b:	8b 5c 24 30          	mov    0x30(%esp),%ebx
40000c7f:	8b 4c 24 34          	mov    0x34(%esp),%ecx
40000c83:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000c87:	85 f6                	test   %esi,%esi
40000c89:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000c8d:	89 ca                	mov    %ecx,%edx
40000c8f:	89 f8                	mov    %edi,%eax
40000c91:	75 3d                	jne    40000cd0 <__udivdi3+0x60>
40000c93:	39 cf                	cmp    %ecx,%edi
40000c95:	0f 87 c5 00 00 00    	ja     40000d60 <__udivdi3+0xf0>
40000c9b:	85 ff                	test   %edi,%edi
40000c9d:	89 fd                	mov    %edi,%ebp
40000c9f:	75 0b                	jne    40000cac <__udivdi3+0x3c>
40000ca1:	b8 01 00 00 00       	mov    $0x1,%eax
40000ca6:	31 d2                	xor    %edx,%edx
40000ca8:	f7 f7                	div    %edi
40000caa:	89 c5                	mov    %eax,%ebp
40000cac:	89 c8                	mov    %ecx,%eax
40000cae:	31 d2                	xor    %edx,%edx
40000cb0:	f7 f5                	div    %ebp
40000cb2:	89 c1                	mov    %eax,%ecx
40000cb4:	89 d8                	mov    %ebx,%eax
40000cb6:	89 cf                	mov    %ecx,%edi
40000cb8:	f7 f5                	div    %ebp
40000cba:	89 c3                	mov    %eax,%ebx
...
40000cd0:	39 ce                	cmp    %ecx,%esi
40000cd2:	77 74                	ja     40000d48 <__udivdi3+0xd8>
40000cd4:	0f bd fe             	bsr    %esi,%edi
40000cd7:	83 f7 1f             	xor    $0x1f,%edi
40000cda:	0f 84 98 00 00 00    	je     40000d78 <__udivdi3+0x108>
40000ce0:	bb 20 00 00 00       	mov    $0x20,%ebx
40000ce5:	89 f9                	mov    %edi,%ecx
40000ce7:	89 c5                	mov    %eax,%ebp
40000ce9:	29 fb                	sub    %edi,%ebx
40000ceb:	d3 e6                	shl    %cl,%esi
40000ced:	89 d9                	mov    %ebx,%ecx
40000cef:	d3 ed                	shr    %cl,%ebp
40000cf1:	89 f9                	mov    %edi,%ecx
40000cf3:	d3 e0                	shl    %cl,%eax
40000cf5:	09 ee                	or     %ebp,%esi
40000cf7:	89 d9                	mov    %ebx,%ecx
40000cf9:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000cfd:	89 d5                	mov    %edx,%ebp
40000cff:	8b 44 24 08          	mov    0x8(%esp),%eax
40000d03:	d3 ed                	shr    %cl,%ebp
40000d05:	89 f9                	mov    %edi,%ecx
40000d07:	d3 e2                	shl    %cl,%edx
40000d09:	89 d9                	mov    %ebx,%ecx
40000d0b:	d3 e8                	shr    %cl,%eax
40000d0d:	09 c2                	or     %eax,%edx
40000d0f:	89 d0                	mov    %edx,%eax
40000d11:	89 ea                	mov    %ebp,%edx
40000d13:	f7 f6                	div    %esi
40000d15:	89 d5                	mov    %edx,%ebp
40000d17:	89 c3                	mov    %eax,%ebx
40000d19:	f7 64 24 0c          	mull   0xc(%esp)
40000d1d:	39 d5                	cmp    %edx,%ebp
40000d1f:	72 10                	jb     40000d31 <__udivdi3+0xc1>
40000d21:	8b 74 24 08          	mov    0x8(%esp),%esi
40000d25:	89 f9                	mov    %edi,%ecx
40000d27:	d3 e6                	shl    %cl,%esi
40000d29:	39 c6                	cmp    %eax,%esi
40000d2b:	73 07                	jae    40000d34 <__udivdi3+0xc4>
40000d2d:	39 d5                	cmp    %edx,%ebp
40000d2f:	75 03                	jne    40000d34 <__udivdi3+0xc4>
40000d31:	83 eb 01             	sub    $0x1,%ebx
40000d34:	31 ff                	xor    %edi,%edi
40000d36:	89 d8                	mov    %ebx,%eax
40000d38:	89 fa                	mov    %edi,%edx
40000d3a:	83 c4 1c             	add    $0x1c,%esp
40000d3d:	5b                   	pop    %ebx
40000d3e:	5e                   	pop    %esi
40000d3f:	5f                   	pop    %edi
40000d40:	5d                   	pop    %ebp
...
40000d48:	31 ff                	xor    %edi,%edi
40000d4a:	31 db                	xor    %ebx,%ebx
40000d4c:	89 d8                	mov    %ebx,%eax
40000d4e:	89 fa                	mov    %edi,%edx
40000d50:	83 c4 1c             	add    $0x1c,%esp
40000d53:	5b                   	pop    %ebx
40000d54:	5e                   	pop    %esi
40000d55:	5f                   	pop    %edi
40000d56:	5d                   	pop    %ebp
...
40000d60:	89 d8                	mov    %ebx,%eax
40000d62:	f7 f7                	div    %edi
40000d64:	31 ff                	xor    %edi,%edi
40000d66:	89 c3                	mov    %eax,%ebx
40000d68:	89 d8                	mov    %ebx,%eax
40000d6a:	89 fa                	mov    %edi,%edx
40000d6c:	83 c4 1c             	add    $0x1c,%esp
40000d6f:	5b                   	pop    %ebx
40000d70:	5e                   	pop    %esi
40000d71:	5f                   	pop    %edi
40000d72:	5d                   	pop    %ebp
...
40000d78:	39 ce                	cmp    %ecx,%esi
40000d7a:	72 0c                	jb     40000d88 <__udivdi3+0x118>
40000d7c:	31 db                	xor    %ebx,%ebx
40000d7e:	3b 44 24 08          	cmp    0x8(%esp),%eax
40000d82:	0f 87 34 ff ff ff    	ja     40000cbc <__udivdi3+0x4c>
40000d88:	bb 01 00 00 00       	mov    $0x1,%ebx
40000d8d:	e9 2a ff ff ff       	jmp    40000cbc <__udivdi3+0x4c>
...
40000da1:	57                   	push   %edi
40000da2:	56                   	push   %esi
40000da3:	53                   	push   %ebx
40000da4:	83 ec 1c             	sub    $0x1c,%esp
40000da7:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000dab:	8b 4c 24 30          	mov    0x30(%esp),%ecx
40000daf:	8b 74 24 34          	mov    0x34(%esp),%esi
40000db3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000db7:	85 c0                	test   %eax,%eax
40000db9:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000dbd:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000dc1:	89 3c 24             	mov    %edi,(%esp)
40000dc4:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000dc8:	89 f2                	mov    %esi,%edx
40000dca:	75 14                	jne    40000de0 <__umoddi3+0x40>
40000dcc:	39 f7                	cmp    %esi,%edi
40000dce:	76 40                	jbe    40000e10 <__umoddi3+0x70>
40000dd0:	89 c8                	mov    %ecx,%eax
40000dd2:	f7 f7                	div    %edi
40000dd4:	89 d0                	mov    %edx,%eax
40000dd6:	31 d2                	xor    %edx,%edx
40000dd8:	83 c4 1c             	add    $0x1c,%esp
40000ddb:	5b                   	pop    %ebx
40000ddc:	5e                   	pop    %esi
40000ddd:	5f                   	pop    %edi
40000dde:	5d                   	pop    %ebp
40000ddf:	c3                   	ret    
40000de0:	39 f0                	cmp    %esi,%eax
40000de2:	89 f3                	mov    %esi,%ebx
40000de4:	77 4a                	ja     40000e30 <__umoddi3+0x90>
40000de6:	0f bd e8             	bsr    %eax,%ebp
40000de9:	83 f5 1f             	xor    $0x1f,%ebp
40000dec:	75 52                	jne    40000e40 <__umoddi3+0xa0>
40000dee:	39 f0                	cmp    %esi,%eax
40000df0:	0f 82 da 00 00 00    	jb     40000ed0 <__umoddi3+0x130>
40000df6:	39 0c 24             	cmp    %ecx,(%esp)
40000df9:	0f 86 d1 00 00 00    	jbe    40000ed0 <__umoddi3+0x130>
40000dff:	8b 44 24 04          	mov    0x4(%esp),%eax
40000e03:	83 c4 1c             	add    $0x1c,%esp
40000e06:	5b                   	pop    %ebx
40000e07:	5e                   	pop    %esi
40000e08:	5f                   	pop    %edi
40000e09:	5d                   	pop    %ebp
...
40000e10:	85 ff                	test   %edi,%edi
40000e12:	89 fd                	mov    %edi,%ebp
40000e14:	75 0b                	jne    40000e21 <__umoddi3+0x81>
40000e16:	b8 01 00 00 00       	mov    $0x1,%eax
40000e1b:	31 d2                	xor    %edx,%edx
40000e1d:	f7 f7                	div    %edi
40000e1f:	89 c5                	mov    %eax,%ebp
40000e21:	89 f0                	mov    %esi,%eax
40000e23:	31 d2                	xor    %edx,%edx
40000e25:	f7 f5                	div    %ebp
40000e27:	89 c8                	mov    %ecx,%eax
40000e29:	f7 f5                	div    %ebp
40000e2b:	eb a7                	jmp    40000dd4 <__umoddi3+0x34>
40000e2d:	8d 76 00             	lea    0x0(%esi),%esi
40000e30:	89 c8                	mov    %ecx,%eax
40000e32:	89 f2                	mov    %esi,%edx
40000e34:	83 c4 1c             	add    $0x1c,%esp
40000e37:	5b                   	pop    %ebx
40000e38:	5e                   	pop    %esi
40000e39:	5f                   	pop    %edi
40000e3a:	5d                   	pop    %ebp
...
40000e40:	8b 34 24             	mov    (%esp),%esi
40000e43:	bf 20 00 00 00       	mov    $0x20,%edi
40000e48:	89 e9                	mov    %ebp,%ecx
40000e4a:	29 ef                	sub    %ebp,%edi
40000e4c:	d3 e0                	shl    %cl,%eax
40000e4e:	89 f9                	mov    %edi,%ecx
40000e50:	89 f2                	mov    %esi,%edx
40000e52:	d3 ea                	shr    %cl,%edx
40000e54:	89 e9                	mov    %ebp,%ecx
40000e56:	09 c2                	or     %eax,%edx
40000e58:	89 d8                	mov    %ebx,%eax
40000e5a:	89 14 24             	mov    %edx,(%esp)
40000e5d:	89 f2                	mov    %esi,%edx
40000e5f:	d3 e2                	shl    %cl,%edx
40000e61:	89 f9                	mov    %edi,%ecx
40000e63:	89 54 24 04          	mov    %edx,0x4(%esp)
40000e67:	8b 54 24 08          	mov    0x8(%esp),%edx
40000e6b:	d3 e8                	shr    %cl,%eax
40000e6d:	89 e9                	mov    %ebp,%ecx
40000e6f:	89 c6                	mov    %eax,%esi
40000e71:	d3 e3                	shl    %cl,%ebx
40000e73:	89 f9                	mov    %edi,%ecx
40000e75:	89 d0                	mov    %edx,%eax
40000e77:	d3 e8                	shr    %cl,%eax
40000e79:	89 e9                	mov    %ebp,%ecx
40000e7b:	09 d8                	or     %ebx,%eax
40000e7d:	89 d3                	mov    %edx,%ebx
40000e7f:	89 f2                	mov    %esi,%edx
40000e81:	f7 34 24             	divl   (%esp)
40000e84:	89 d6                	mov    %edx,%esi
40000e86:	d3 e3                	shl    %cl,%ebx
40000e88:	f7 64 24 04          	mull   0x4(%esp)
40000e8c:	39 d6                	cmp    %edx,%esi
40000e8e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000e92:	89 d1                	mov    %edx,%ecx
40000e94:	89 c3                	mov    %eax,%ebx
40000e96:	72 08                	jb     40000ea0 <__umoddi3+0x100>
40000e98:	75 11                	jne    40000eab <__umoddi3+0x10b>
40000e9a:	39 44 24 08          	cmp    %eax,0x8(%esp)
40000e9e:	73 0b                	jae    40000eab <__umoddi3+0x10b>
40000ea0:	2b 44 24 04          	sub    0x4(%esp),%eax
40000ea4:	1b 14 24             	sbb    (%esp),%edx
40000ea7:	89 d1                	mov    %edx,%ecx
40000ea9:	89 c3                	mov    %eax,%ebx
40000eab:	8b 54 24 08          	mov    0x8(%esp),%edx
40000eaf:	29 da                	sub    %ebx,%edx
40000eb1:	19 ce                	sbb    %ecx,%esi
40000eb3:	89 f9                	mov    %edi,%ecx
40000eb5:	89 f0                	mov    %esi,%eax
40000eb7:	d3 e0                	shl    %cl,%eax
40000eb9:	89 e9                	mov    %ebp,%ecx
40000ebb:	d3 ea                	shr    %cl,%edx
40000ebd:	89 e9                	mov    %ebp,%ecx
40000ebf:	d3 ee                	shr    %cl,%esi
40000ec1:	09 d0                	or     %edx,%eax
40000ec3:	89 f2                	mov    %esi,%edx
40000ec5:	83 c4 1c             	add    $0x1c,%esp
40000ec8:	5b                   	pop    %ebx
40000ec9:	5e                   	pop    %esi
40000eca:	5f                   	pop    %edi
40000ecb:	5d                   	pop    %ebp
...
40000ed0:	89 f2                	mov    %esi,%edx
40000ed2:	29 f9                	sub    %edi,%ecx
40000ed4:	1b 54 24 0c          	sbb    0xc(%esp),%edx
40000ed8:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000edc:	e9 1e ff ff ff       	jmp    40000dff <__umoddi3+0x5f>
