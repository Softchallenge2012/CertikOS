...
40000c1f:	68 2c 01 00 00       	push   $0x12c
40000c24:	8d 83 ac e0 ff ff    	lea    -0x1f54(%ebx),%eax
40000c2a:	50                   	push   %eax
40000c2b:	e8 c2 f5 ff ff       	call   400001f2 <printf>
    *addr = val;
40000c30:	c7 05 00 00 00 e0 2c 	movl   $0x12c,0xe0000000
40000c37:	01 00 00 
    yield();
40000c3a:	e8 b9 fb ff ff       	call   400007f8 <yield>
    printf("ding: the new value at address %x: %d\n", addr, *addr);
40000c3f:	83 c4 0c             	add    $0xc,%esp
40000c42:	ff 35 00 00 00 e0    	pushl  0xe0000000
40000c48:	68 00 00 00 e0       	push   $0xe0000000
40000c4d:	8d 83 dc e0 ff ff    	lea    -0x1f24(%ebx),%eax
40000c53:	50                   	push   %eax
40000c54:	e8 99 f5 ff ff       	call   400001f2 <printf>
40000c59:	83 c4 10             	add    $0x10,%esp

    return 0;
}
40000c5c:	b8 00 00 00 00       	mov    $0x0,%eax
40000c61:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000c64:	59                   	pop    %ecx
40000c65:	5b                   	pop    %ebx
40000c66:	5d                   	pop    %ebp
40000c67:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c6a:	c3                   	ret    
40000c6b:	66 90                	xchg   %ax,%ax
40000c6d:	66 90                	xchg   %ax,%ax
40000c6f:	90                   	nop
