...
40000030:	8d 83 44 df ff ff    	lea    -0x20bc(%ebx),%eax
...
40000069:	8d 83 50 df ff ff    	lea    -0x20b0(%ebx),%eax
...
400000a2:	8d 83 5c df ff ff    	lea    -0x20a4(%ebx),%eax
...
4000027b:	e8 50 0a 00 00       	call   40000cd0 <__udivdi3>
...
400002ba:	e8 41 0b 00 00       	call   40000e00 <__umoddi3>
400002bf:	83 c4 08             	add    $0x8,%esp
400002c2:	57                   	push   %edi
400002c3:	0f be 84 05 68 df ff 	movsbl -0x2098(%ebp,%eax,1),%eax
400002ca:	ff 
...
400003e4:	03 8c 81 80 df ff ff 	add    -0x2080(%ecx,%eax,4),%ecx
...
400004fb:	8d 80 79 df ff ff    	lea    -0x2087(%eax),%eax
...
40000be2:	51                   	push   %ecx
40000be3:	e8 e1 f4 ff ff       	call   400000c9 <__x86.get_pc_thunk.bx>
40000be8:	81 c3 18 24 00 00    	add    $0x2418,%ebx
    printf ("idle\n");
40000bee:	83 ec 0c             	sub    $0xc,%esp
40000bf1:	8d 83 d8 e0 ff ff    	lea    -0x1f28(%ebx),%eax
40000bf7:	50                   	push   %eax
40000bf8:	e8 f5 f5 ff ff       	call   400001f2 <printf>

    pid_t ping_pid, pong_pid, ding_pid;

    if ((ping_pid = spawn (1, 1000)) != NUM_IDS)
40000bfd:	83 c4 08             	add    $0x8,%esp
40000c00:	68 e8 03 00 00       	push   $0x3e8
40000c05:	6a 01                	push   $0x1
40000c07:	e8 cd fb ff ff       	call   400007d9 <spawn>
40000c0c:	83 c4 10             	add    $0x10,%esp
40000c0f:	83 f8 40             	cmp    $0x40,%eax
40000c12:	74 76                	je     40000c8a <main+0xb6>
        printf ("ping in process %d.\n", ping_pid);
40000c14:	83 ec 08             	sub    $0x8,%esp
40000c17:	50                   	push   %eax
40000c18:	8d 83 de e0 ff ff    	lea    -0x1f22(%ebx),%eax
40000c1e:	50                   	push   %eax
40000c1f:	e8 ce f5 ff ff       	call   400001f2 <printf>
...
40000c2a:	68 e8 03 00 00       	push   $0x3e8
40000c2f:	6a 02                	push   $0x2
40000c31:	e8 a3 fb ff ff       	call   400007d9 <spawn>
40000c36:	83 c4 10             	add    $0x10,%esp
40000c39:	83 f8 40             	cmp    $0x40,%eax
40000c3c:	74 60                	je     40000c9e <main+0xca>
        printf ("pong in process %d.\n", pong_pid);
40000c3e:	83 ec 08             	sub    $0x8,%esp
40000c41:	50                   	push   %eax
40000c42:	8d 83 0b e1 ff ff    	lea    -0x1ef5(%ebx),%eax
...
40000c54:	68 e8 03 00 00       	push   $0x3e8
40000c59:	6a 03                	push   $0x3
40000c5b:	e8 79 fb ff ff       	call   400007d9 <spawn>
40000c60:	83 c4 10             	add    $0x10,%esp
40000c63:	83 f8 40             	cmp    $0x40,%eax
40000c66:	74 4a                	je     40000cb2 <main+0xde>
        printf ("ding in process %d.\n", ding_pid);
40000c68:	83 ec 08             	sub    $0x8,%esp
40000c6b:	50                   	push   %eax
40000c6c:	8d 83 38 e1 ff ff    	lea    -0x1ec8(%ebx),%eax
40000c72:	50                   	push   %eax
40000c73:	e8 7a f5 ff ff       	call   400001f2 <printf>
40000c78:	83 c4 10             	add    $0x10,%esp
    else
        printf ("Failed to launch ding.\n");

    return 0;
}
40000c7b:	b8 00 00 00 00       	mov    $0x0,%eax
40000c80:	8d 65 f8             	lea    -0x8(%ebp),%esp
40000c83:	59                   	pop    %ecx
40000c84:	5b                   	pop    %ebx
40000c85:	5d                   	pop    %ebp
40000c86:	8d 61 fc             	lea    -0x4(%ecx),%esp
40000c89:	c3                   	ret    
        printf ("Failed to launch ping.\n");
40000c8a:	83 ec 0c             	sub    $0xc,%esp
40000c8d:	8d 83 f3 e0 ff ff    	lea    -0x1f0d(%ebx),%eax
40000c93:	50                   	push   %eax
40000c94:	e8 59 f5 ff ff       	call   400001f2 <printf>
40000c99:	83 c4 10             	add    $0x10,%esp
40000c9c:	eb 89                	jmp    40000c27 <main+0x53>
        printf ("Failed to launch pong.\n");
40000c9e:	83 ec 0c             	sub    $0xc,%esp
40000ca1:	8d 83 20 e1 ff ff    	lea    -0x1ee0(%ebx),%eax
40000ca7:	50                   	push   %eax
40000ca8:	e8 45 f5 ff ff       	call   400001f2 <printf>
40000cad:	83 c4 10             	add    $0x10,%esp
40000cb0:	eb 9f                	jmp    40000c51 <main+0x7d>
        printf ("Failed to launch ding.\n");
40000cb2:	83 ec 0c             	sub    $0xc,%esp
40000cb5:	8d 83 4d e1 ff ff    	lea    -0x1eb3(%ebx),%eax
40000cbb:	50                   	push   %eax
40000cbc:	e8 31 f5 ff ff       	call   400001f2 <printf>
40000cc1:	83 c4 10             	add    $0x10,%esp
40000cc4:	eb b5                	jmp    40000c7b <main+0xa7>
...
40000cd7:	8b 74 24 3c          	mov    0x3c(%esp),%esi
40000cdb:	8b 5c 24 30          	mov    0x30(%esp),%ebx
40000cdf:	8b 4c 24 34          	mov    0x34(%esp),%ecx
40000ce3:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000ce7:	85 f6                	test   %esi,%esi
40000ce9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000ced:	89 ca                	mov    %ecx,%edx
40000cef:	89 f8                	mov    %edi,%eax
40000cf1:	75 3d                	jne    40000d30 <__udivdi3+0x60>
40000cf3:	39 cf                	cmp    %ecx,%edi
40000cf5:	0f 87 c5 00 00 00    	ja     40000dc0 <__udivdi3+0xf0>
40000cfb:	85 ff                	test   %edi,%edi
40000cfd:	89 fd                	mov    %edi,%ebp
40000cff:	75 0b                	jne    40000d0c <__udivdi3+0x3c>
40000d01:	b8 01 00 00 00       	mov    $0x1,%eax
40000d06:	31 d2                	xor    %edx,%edx
40000d08:	f7 f7                	div    %edi
40000d0a:	89 c5                	mov    %eax,%ebp
40000d0c:	89 c8                	mov    %ecx,%eax
40000d0e:	31 d2                	xor    %edx,%edx
40000d10:	f7 f5                	div    %ebp
40000d12:	89 c1                	mov    %eax,%ecx
40000d14:	89 d8                	mov    %ebx,%eax
40000d16:	89 cf                	mov    %ecx,%edi
40000d18:	f7 f5                	div    %ebp
40000d1a:	89 c3                	mov    %eax,%ebx
...
40000d30:	39 ce                	cmp    %ecx,%esi
40000d32:	77 74                	ja     40000da8 <__udivdi3+0xd8>
40000d34:	0f bd fe             	bsr    %esi,%edi
40000d37:	83 f7 1f             	xor    $0x1f,%edi
40000d3a:	0f 84 98 00 00 00    	je     40000dd8 <__udivdi3+0x108>
40000d40:	bb 20 00 00 00       	mov    $0x20,%ebx
40000d45:	89 f9                	mov    %edi,%ecx
40000d47:	89 c5                	mov    %eax,%ebp
40000d49:	29 fb                	sub    %edi,%ebx
40000d4b:	d3 e6                	shl    %cl,%esi
40000d4d:	89 d9                	mov    %ebx,%ecx
40000d4f:	d3 ed                	shr    %cl,%ebp
40000d51:	89 f9                	mov    %edi,%ecx
40000d53:	d3 e0                	shl    %cl,%eax
40000d55:	09 ee                	or     %ebp,%esi
40000d57:	89 d9                	mov    %ebx,%ecx
40000d59:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000d5d:	89 d5                	mov    %edx,%ebp
40000d5f:	8b 44 24 08          	mov    0x8(%esp),%eax
40000d63:	d3 ed                	shr    %cl,%ebp
40000d65:	89 f9                	mov    %edi,%ecx
40000d67:	d3 e2                	shl    %cl,%edx
40000d69:	89 d9                	mov    %ebx,%ecx
40000d6b:	d3 e8                	shr    %cl,%eax
40000d6d:	09 c2                	or     %eax,%edx
40000d6f:	89 d0                	mov    %edx,%eax
40000d71:	89 ea                	mov    %ebp,%edx
40000d73:	f7 f6                	div    %esi
40000d75:	89 d5                	mov    %edx,%ebp
40000d77:	89 c3                	mov    %eax,%ebx
40000d79:	f7 64 24 0c          	mull   0xc(%esp)
40000d7d:	39 d5                	cmp    %edx,%ebp
40000d7f:	72 10                	jb     40000d91 <__udivdi3+0xc1>
40000d81:	8b 74 24 08          	mov    0x8(%esp),%esi
40000d85:	89 f9                	mov    %edi,%ecx
40000d87:	d3 e6                	shl    %cl,%esi
40000d89:	39 c6                	cmp    %eax,%esi
40000d8b:	73 07                	jae    40000d94 <__udivdi3+0xc4>
40000d8d:	39 d5                	cmp    %edx,%ebp
40000d8f:	75 03                	jne    40000d94 <__udivdi3+0xc4>
40000d91:	83 eb 01             	sub    $0x1,%ebx
40000d94:	31 ff                	xor    %edi,%edi
40000d96:	89 d8                	mov    %ebx,%eax
40000d98:	89 fa                	mov    %edi,%edx
40000d9a:	83 c4 1c             	add    $0x1c,%esp
40000d9d:	5b                   	pop    %ebx
40000d9e:	5e                   	pop    %esi
40000d9f:	5f                   	pop    %edi
40000da0:	5d                   	pop    %ebp
...
40000da8:	31 ff                	xor    %edi,%edi
40000daa:	31 db                	xor    %ebx,%ebx
40000dac:	89 d8                	mov    %ebx,%eax
40000dae:	89 fa                	mov    %edi,%edx
40000db0:	83 c4 1c             	add    $0x1c,%esp
40000db3:	5b                   	pop    %ebx
40000db4:	5e                   	pop    %esi
40000db5:	5f                   	pop    %edi
40000db6:	5d                   	pop    %ebp
...
40000dc0:	89 d8                	mov    %ebx,%eax
40000dc2:	f7 f7                	div    %edi
40000dc4:	31 ff                	xor    %edi,%edi
40000dc6:	89 c3                	mov    %eax,%ebx
40000dc8:	89 d8                	mov    %ebx,%eax
40000dca:	89 fa                	mov    %edi,%edx
40000dcc:	83 c4 1c             	add    $0x1c,%esp
40000dcf:	5b                   	pop    %ebx
40000dd0:	5e                   	pop    %esi
40000dd1:	5f                   	pop    %edi
40000dd2:	5d                   	pop    %ebp
...
40000dd8:	39 ce                	cmp    %ecx,%esi
40000dda:	72 0c                	jb     40000de8 <__udivdi3+0x118>
40000ddc:	31 db                	xor    %ebx,%ebx
40000dde:	3b 44 24 08          	cmp    0x8(%esp),%eax
40000de2:	0f 87 34 ff ff ff    	ja     40000d1c <__udivdi3+0x4c>
40000de8:	bb 01 00 00 00       	mov    $0x1,%ebx
40000ded:	e9 2a ff ff ff       	jmp    40000d1c <__udivdi3+0x4c>
40000df2:	66 90                	xchg   %ax,%ax
40000df4:	66 90                	xchg   %ax,%ax
40000df6:	66 90                	xchg   %ax,%ax
40000df8:	66 90                	xchg   %ax,%ax
40000dfa:	66 90                	xchg   %ax,%ax
40000dfc:	66 90                	xchg   %ax,%ax
...
40000e04:	83 ec 1c             	sub    $0x1c,%esp
40000e07:	8b 44 24 3c          	mov    0x3c(%esp),%eax
40000e0b:	8b 4c 24 30          	mov    0x30(%esp),%ecx
40000e0f:	8b 74 24 34          	mov    0x34(%esp),%esi
40000e13:	8b 7c 24 38          	mov    0x38(%esp),%edi
40000e17:	85 c0                	test   %eax,%eax
40000e19:	89 44 24 0c          	mov    %eax,0xc(%esp)
40000e1d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
40000e21:	89 3c 24             	mov    %edi,(%esp)
40000e24:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000e28:	89 f2                	mov    %esi,%edx
40000e2a:	75 14                	jne    40000e40 <__umoddi3+0x40>
40000e2c:	39 f7                	cmp    %esi,%edi
40000e2e:	76 40                	jbe    40000e70 <__umoddi3+0x70>
40000e30:	89 c8                	mov    %ecx,%eax
40000e32:	f7 f7                	div    %edi
40000e34:	89 d0                	mov    %edx,%eax
40000e36:	31 d2                	xor    %edx,%edx
40000e38:	83 c4 1c             	add    $0x1c,%esp
40000e3b:	5b                   	pop    %ebx
40000e3c:	5e                   	pop    %esi
40000e3d:	5f                   	pop    %edi
40000e3e:	5d                   	pop    %ebp
40000e3f:	c3                   	ret    
40000e40:	39 f0                	cmp    %esi,%eax
40000e42:	89 f3                	mov    %esi,%ebx
40000e44:	77 4a                	ja     40000e90 <__umoddi3+0x90>
40000e46:	0f bd e8             	bsr    %eax,%ebp
40000e49:	83 f5 1f             	xor    $0x1f,%ebp
40000e4c:	75 52                	jne    40000ea0 <__umoddi3+0xa0>
40000e4e:	39 f0                	cmp    %esi,%eax
40000e50:	0f 82 da 00 00 00    	jb     40000f30 <__umoddi3+0x130>
40000e56:	39 0c 24             	cmp    %ecx,(%esp)
40000e59:	0f 86 d1 00 00 00    	jbe    40000f30 <__umoddi3+0x130>
40000e5f:	8b 44 24 04          	mov    0x4(%esp),%eax
40000e63:	83 c4 1c             	add    $0x1c,%esp
40000e66:	5b                   	pop    %ebx
40000e67:	5e                   	pop    %esi
40000e68:	5f                   	pop    %edi
40000e69:	5d                   	pop    %ebp
...
40000e70:	85 ff                	test   %edi,%edi
40000e72:	89 fd                	mov    %edi,%ebp
40000e74:	75 0b                	jne    40000e81 <__umoddi3+0x81>
40000e76:	b8 01 00 00 00       	mov    $0x1,%eax
40000e7b:	31 d2                	xor    %edx,%edx
40000e7d:	f7 f7                	div    %edi
40000e7f:	89 c5                	mov    %eax,%ebp
40000e81:	89 f0                	mov    %esi,%eax
40000e83:	31 d2                	xor    %edx,%edx
40000e85:	f7 f5                	div    %ebp
40000e87:	89 c8                	mov    %ecx,%eax
40000e89:	f7 f5                	div    %ebp
40000e8b:	eb a7                	jmp    40000e34 <__umoddi3+0x34>
40000e8d:	8d 76 00             	lea    0x0(%esi),%esi
40000e90:	89 c8                	mov    %ecx,%eax
40000e92:	89 f2                	mov    %esi,%edx
40000e94:	83 c4 1c             	add    $0x1c,%esp
40000e97:	5b                   	pop    %ebx
40000e98:	5e                   	pop    %esi
40000e99:	5f                   	pop    %edi
40000e9a:	5d                   	pop    %ebp
...
40000ea0:	8b 34 24             	mov    (%esp),%esi
40000ea3:	bf 20 00 00 00       	mov    $0x20,%edi
40000ea8:	89 e9                	mov    %ebp,%ecx
40000eaa:	29 ef                	sub    %ebp,%edi
40000eac:	d3 e0                	shl    %cl,%eax
40000eae:	89 f9                	mov    %edi,%ecx
40000eb0:	89 f2                	mov    %esi,%edx
40000eb2:	d3 ea                	shr    %cl,%edx
40000eb4:	89 e9                	mov    %ebp,%ecx
40000eb6:	09 c2                	or     %eax,%edx
40000eb8:	89 d8                	mov    %ebx,%eax
40000eba:	89 14 24             	mov    %edx,(%esp)
40000ebd:	89 f2                	mov    %esi,%edx
40000ebf:	d3 e2                	shl    %cl,%edx
40000ec1:	89 f9                	mov    %edi,%ecx
40000ec3:	89 54 24 04          	mov    %edx,0x4(%esp)
40000ec7:	8b 54 24 08          	mov    0x8(%esp),%edx
40000ecb:	d3 e8                	shr    %cl,%eax
40000ecd:	89 e9                	mov    %ebp,%ecx
40000ecf:	89 c6                	mov    %eax,%esi
40000ed1:	d3 e3                	shl    %cl,%ebx
40000ed3:	89 f9                	mov    %edi,%ecx
40000ed5:	89 d0                	mov    %edx,%eax
40000ed7:	d3 e8                	shr    %cl,%eax
40000ed9:	89 e9                	mov    %ebp,%ecx
40000edb:	09 d8                	or     %ebx,%eax
40000edd:	89 d3                	mov    %edx,%ebx
40000edf:	89 f2                	mov    %esi,%edx
40000ee1:	f7 34 24             	divl   (%esp)
40000ee4:	89 d6                	mov    %edx,%esi
40000ee6:	d3 e3                	shl    %cl,%ebx
40000ee8:	f7 64 24 04          	mull   0x4(%esp)
40000eec:	39 d6                	cmp    %edx,%esi
40000eee:	89 5c 24 08          	mov    %ebx,0x8(%esp)
40000ef2:	89 d1                	mov    %edx,%ecx
40000ef4:	89 c3                	mov    %eax,%ebx
40000ef6:	72 08                	jb     40000f00 <__umoddi3+0x100>
40000ef8:	75 11                	jne    40000f0b <__umoddi3+0x10b>
40000efa:	39 44 24 08          	cmp    %eax,0x8(%esp)
40000efe:	73 0b                	jae    40000f0b <__umoddi3+0x10b>
40000f00:	2b 44 24 04          	sub    0x4(%esp),%eax
40000f04:	1b 14 24             	sbb    (%esp),%edx
40000f07:	89 d1                	mov    %edx,%ecx
40000f09:	89 c3                	mov    %eax,%ebx
40000f0b:	8b 54 24 08          	mov    0x8(%esp),%edx
40000f0f:	29 da                	sub    %ebx,%edx
40000f11:	19 ce                	sbb    %ecx,%esi
40000f13:	89 f9                	mov    %edi,%ecx
40000f15:	89 f0                	mov    %esi,%eax
40000f17:	d3 e0                	shl    %cl,%eax
40000f19:	89 e9                	mov    %ebp,%ecx
40000f1b:	d3 ea                	shr    %cl,%edx
40000f1d:	89 e9                	mov    %ebp,%ecx
40000f1f:	d3 ee                	shr    %cl,%esi
40000f21:	09 d0                	or     %edx,%eax
40000f23:	89 f2                	mov    %esi,%edx
40000f25:	83 c4 1c             	add    $0x1c,%esp
40000f28:	5b                   	pop    %ebx
40000f29:	5e                   	pop    %esi
40000f2a:	5f                   	pop    %edi
40000f2b:	5d                   	pop    %ebp
...
40000f30:	89 f2                	mov    %esi,%edx
40000f32:	29 f9                	sub    %edi,%ecx
40000f34:	1b 54 24 0c          	sbb    0xc(%esp),%edx
40000f38:	89 4c 24 04          	mov    %ecx,0x4(%esp)
40000f3c:	e9 1e ff ff ff       	jmp    40000e5f <__umoddi3+0x5f>
